...
class SignLearnScreen extends StatelessWidget {
  int index;
  int categoryIndex;
  SignLearnScreen({required this.index, required this.categoryIndex, super.key});
            ...
            return Scaffold(
              body: Column(
                ...
                [
                  ...
                  AppCubit.get(context).cameraOpen ? Column(
                    children:
                    [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: FutureBuilder(
                            future: AppCubit.get(context).learnCamera(categoryDataIndex: categoryIndex, categoryDataDetailsIndex: index),
